...
Welcome to the DSA learning repository. This repository contains implementations of various data structures, sorting and searching algorithms, matrix operations, and solutions to LeetCode coding problems using Java.
...
| 📁 **LeetCode Solutions** | Individual folders containing solution code and explanations for LeetCode problems. | Palindrome Number, Remove Duplicates, Trapping Rain Water, Reverse String |
...
graph TD
    ...
    DSA --> LeetCode[LeetCode Problems]
...
Detailed solutions with problems descriptions:

1. **[0009 - Palindrome Number](./0009-palindrome-number)**
2. **[0026 - Remove Duplicates from Sorted Array](./0026-remove-duplicates-from-sorted-array)**
3. **[0042 - Trapping Rain Water](./0042-trapping-rain-water)**
4. **[0344 - Reverse String](./0344-reverse-string)**
